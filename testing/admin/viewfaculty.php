			...
			<table class="table">
				...
				<tbody>
					...
					<tr> 
						...
						<td> <?php echo $en['Designation'];?> </td>
						<td><img class="img-responsive " src="images/<?php echo $en['Images']; ?>" style="width: 100px; height: 100px;"></td>
						<td><a href="delete6.php?id=<?php echo $en['uid']; ?>" class="btn btn-danger btn-sm"> DELETE </a> |</td>
					</tr>
					<?php  $a++; } ?>
				</tbody>
			</table>
